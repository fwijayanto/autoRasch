...
#' The Interdisciplinary Education Perception Scale (IEPS) Dataset with 2 Covariates
#'
...
#'
#' @references
#' Vaughan, B. (2019). Measurement Properties of the Interdisciplinary Education Perception Scale in an Australian Allied Health Student Cohort. Health Professions Education, 5(3), 275–280. https://doi.org/10.1016/j.hpe.2018.07.005
#'
#' @rdname ieps
"ieps"
...
#'
#' The pre-processed version of the OCTQ dataset in (Vaughan, 2018).
#'
#' @docType data
#'
#' @usage data(octq)
#'
#' @references
#' Vaughan, B. (2018). Exploring the measurement properties of the osteopathy clinical teaching questionnaire using Rasch analysis. Chiropractic and Manual Therapies, 26(1), 1–16. https://doi.org/10.1186/s12998-018-0182-2#'
#'
#' @rdname octq
"octq"

#' The Multiple Sclerosis Quality of Life (MSQOL)
#'
#' The pre-processed version of the MSQOL dataset in (Rosato et al., 2016).
#'
#' @docType data
#'
#' @usage data(msqol)
#'
#' @references
#' Rosato, R., Testa, S., Bertolotto, A., Confalonieri, P., Patti, F., Lugaresi, A., … Solari, A. (2016). Development of a short version of MSQOL- 54 using factor analysis and item response theory. PLoS ONE, 11(4), 1–15. https://doi.org/10.1371/journal.pone.0153466#'
#'
#' @rdname msqol
"msqol"
