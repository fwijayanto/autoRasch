...
#'
#' \code{fitStats} compute the fit statistics (e.g., Outfit and Infit) of the PCM-DIF model estimation (items and persons).
#'
#' @param obj The object of class \code{'pcm_dif'}.
